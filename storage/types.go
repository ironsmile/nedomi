...
type newStorageFunc func(cfg *config.CacheZoneSection, log types.Logger) types.Storage

var storageTypes = map[string]newStorageFunc{

	"disk": func(cfg *config.CacheZoneSection, log types.Logger) types.Storage {
