...
var reqRangeTests = []reqRangeTest{
	...
	{r: "bytes=0-0", size: 1, expRanges: []Range{{0, 1}}},
	{r: "bytes=0-10", size: 1, expRanges: []Range{{0, 1}}},
	{r: "bytes=0-", size: 1, expRanges: []Range{{0, 1}}},
	{r: "bytes=-5", size: 1, expRanges: []Range{{0, 1}}},

	{r: "", size: 11, expRanges: nil},
	{r: "bytes=0-4", size: 11, expRanges: []Range{{0, 5}}},
	{r: "bytes=2-", size: 11, expRanges: []Range{{2, 9}}},
	{r: "bytes=-5", size: 11, expRanges: []Range{{6, 5}}},
	{r: "bytes=3-7", size: 11, expRanges: []Range{{3, 5}}},

	{r: "bytes=0-0,-2", size: 11, expRanges: []Range{{0, 1}, {9, 2}}},
	{r: "bytes=0-1,5-8", size: 11, expRanges: []Range{{0, 2}, {5, 4}}},
	{r: "bytes=0-1,5-", size: 11, expRanges: []Range{{0, 2}, {5, 6}}},
	{r: "bytes=5-1000", size: 11, expRanges: []Range{{5, 6}}},
	{r: "bytes=0-,1-,2-,3-,4-", size: 9, expRanges: []Range{{0, 9}, {1, 8}, {2, 7}, {3, 6}, {4, 5}}},
	{r: "bytes=0-9", size: 11, expRanges: []Range{{0, 10}}},
	{r: "bytes=0-10", size: 11, expRanges: []Range{{0, 11}}},
	{r: "bytes=0-11", size: 11, expRanges: []Range{{0, 11}}},
	{r: "bytes=0-12", size: 11, expRanges: []Range{{0, 11}}},
	{r: "bytes=10-11", size: 11, expRanges: []Range{{10, 1}}},
	{r: "bytes=10-", size: 11, expRanges: []Range{{10, 1}}},
...
func testReverse(t *testing.T, test reqRangeTest, ranges []Range) {
	for _, rng := range ranges {
		rev, err := ParseResponseContentRange(rng.ContentRange(test.size))
		if err != nil {
...
func TestRequestRangeParsing(t *testing.T) {
	...
	for _, test := range reqRangeTests {
		ranges, err := ParseRequestRange(test.r, test.size)
